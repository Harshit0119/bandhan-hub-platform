...
export function Navbar({ transparent = false }: NavbarProps) {
  ...
  // 🚀 Optimized scroll listener (throttled via rAF)
  useEffect(() => {
    let ticking = false
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            {[
              ...
              { href: "/vendors?category=Photographer", label: "Photographers" },
              { href: "/vendors?category=Wedding Planner", label: "Planners" },
              { href: "/vendors?category=Makeup Artist", label: "Makeup" },
            ].map((link) => (
              <Link
                key={link.href}
                href={link.href}
          ...
          >
            {mobileMenuOpen ? (
              <X className={`h-6 w-6 ${transparent ? 'text-white' : ''}`} />
            ) : (
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
              ...
              {[
                ...
                { href: "/vendors?category=Photographer", label: "Photographers" },
                { href: "/vendors?category=Wedding Planner", label: "Planners" },
                { href: "/vendors?category=Makeup Artist", label: "Makeup Artists" },
              ].map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
              ...
              <div className="border-t pt-4 flex flex-col gap-2">
                {user ? (
                  ...
                  <>
                    ...
                    <Link href="/signup?vendor=true" onClick={closeMenu}>
